...
when RHI == "vulkan" {
        ...
        _command_buffer_submit :: proc(d: ^Device, cb: ^Command_Buffer) -> (res: Result) {
                return _vk_command_buffer_submit(d, cb)
        }
        ...
        */
        ...
        _vk_subresource_range :: #force_inline proc(aspect: vk.ImageAspectFlags) -> vk.ImageSubresourceRange {
        ...
        _vk_command_buffer_submit :: proc(d: ^Device, cb: ^Command_Buffer) -> Result {
                queue: vk.Queue
        ...
        _vk_cmd_reset_render_targets :: proc(d: ^Device, cb: ^Command_Buffer, color_target, depth_stencil_target: ^Texture) {
                i : u32 = 0
                barriers: [2]vk.ImageMemoryBarrier2 

                color_range := _vk_subresource_range({.COLOR})
                depth_range := _vk_subresource_range({.DEPTH, .STENCIL})
