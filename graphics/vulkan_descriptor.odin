...
_create_descriptor_pool :: proc(descriptor_pool: ^vk.DescriptorPool) -> (ok: bool) {
...
_create_descriptor_set_layout :: proc(descriptor_set_layout: ^vk.DescriptorSetLayout) -> (ok: bool) {
    ...
    defer if !ok do _destroy_descriptor_set_layout(descriptor_set_layout)

    return true

}

_destroy_descriptor_set_layout :: proc(layout: ^vk.DescriptorSetLayout) {
    using bound_state
